package com.example.mystudents.uplFragments.teachers;
...
public class TeachUplFragment extends Fragment {

    private FragmentTeachUplBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentTeachUplBinding.inflate(inflater,container,false);
        ...
        uploder = root.findViewById(R.id.uploder);
        upl = root.findViewById(R.id.upl);
        success = root.findViewById(R.id.succ);
        bar = root.findViewById(R.id.uplBar);
    ...
    private void path(){
        ...
        String path = "/storage/emulated/0/Download/Teachers.xlsx";
    ...
    private void readExcel() throws InvalidFormatException, IOException {
        ...
        for(int i=1;i<=rCount;i++){
            ...
            upl = new StaffStruct(details[0],details[2],details[3],details[6],details[4],details[1],details[5],details[8],details[7]);
            ...
            //signUp(details[1],details[7],upl);
    ...
    private boolean uploadTeachers(StaffStruct temp){

        mStore.collection(temp.getSchool()).document("Human resources").collection("FacultyList").document(temp.getStaffID()).set(temp)
    ...
    private void signUp(String email,String dob,StaffStruct upl){
